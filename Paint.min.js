...
Paint.prototype.tools = {
	zoom: function zoom (paint, event) {
		...
		if ((event.type == "mousemove" || event.type == "touchmove") && paint.lastZoomPoint) {
			...
			var currentMiddleX = paint.public.leftTopX + paint.canvasArray[0].width / paint.public.zoom / 2;
	var currentMiddleY = paint.public.leftTopY + paint.canvasArray[0].height / paint.public.zoom / 2;
			...
			if(scale < 0) { // zoom out
				...
				paint.zoomAbsolute(paint.public.zoom * ( zoomFactor ), x2 / 2 / zoomFactor + 960, 0);
			}
